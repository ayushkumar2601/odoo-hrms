                      ...
                      <div className="text-sm leading-relaxed space-y-1.5">
                        <ReactMarkdown 
                          ...
                          components={{
                            ...
                            strong: ({ children }) => <strong className="font-semibold text-slate-900 bg-blue-50/80 px-1 py-0.5 rounded border border-blue-200/60">{children}</strong>,
                            ul: ({ children }) => <ul className="list-disc list-inside space-y-1 my-1.5 pl-1 text-slate-700">{children}</ul>,
                            ol: ({ children }) => <ol className="list-decimal list-inside space-y-1 my-1.5 pl-1 text-slate-700">{children}</ol>,
                            li: ({ children }) => <li className="leading-relaxed">{children}</li>,
                            h3: ({ children }) => <h3 className="font-bold text-sm mt-3 mb-1 text-slate-900 border-b border-slate-200 pb-1">{children}</h3>,
                            h4: ({ children }) => <h4 className="font-semibold text-xs mt-2 mb-1 text-slate-800">{children}</h4>,
                            code: ({ children }) => <code className="bg-slate-100 text-blue-700 px-1 py-0.5 rounded text-[11px] font-mono border border-slate-200">{children}</code>,
                          }}
                        >
                          {msg.content}
                        </ReactMarkdown>
